...
GLOBAL PrintCharacterWithTeletypeOutput_, GetDosTime_
...
;		Nothing
;	Returns:
;		Struct DOS_TIME with members in:
;			AH:			Hour
;			AL:			Minute
;			DH:			Second
;			DL:			1/100 seconds (some systems always return 0)
;	Corrupts registers:
;		Nothing
;--------------------------------------------------------------------
GetDosTime_:
